...
<div>
    ...
    <header class="header">
     ...
     <section class="hero spad set-bg" :style="{'background-image': 'url('+ require('@/assets/img/hero/hero-bg.jpg' ) + ')'}" >
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="hero__pic set-bg" data-setbg="img/hero/hero-video.png" :style="{'background-image': 'url('+ require('@/assets/img/hero/hero-video.png' ) + ')'}">
    ...
    <section class="callto spad set-bg" style="background:black" data-setbg="img/call-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12" v-for="num in 8" :key="num">
                      <div class="col-lg-12 mix entrepreneurship">
                    <div class="mb-1">
                       
                        <div class="podcast_item_text">
        ...
        <div class="container">
            ...
            <div class="row podcast-filter">
                <div class="col-lg-12 mix entrepreneurship">
                    <div class="podcast__item">
                        <div class="podcast__item__pic">
                            <img src="@/assets/img/podcast/podcast-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-12 mix media">
                    <div class="podcast__item">
                        <div class="podcast__item__pic">
                            <img src="@/assets/img/podcast/podcast-2.jpg" alt="">
                        </div>
                        <div class="podcast__item__text">
                            <a href="#" class="heart-icon"><i class="fa fa-heart"></i></a>
                            <ul>
                ...
                <div class="col-lg-12 mix tech">
                    <div class="podcast__item ">
                        <div class="podcast__item__pic">
                            <img src="@/assets/img/podcast/podcast-3.jpg" alt="">
                        </div>
                        <div class="podcast__item__text">
                            <a href="#" class="heart-icon"><i class="fa fa-heart"></i></a>
                            <ul>
                ...
                <div class="col-lg-12 mix tutorials">
                    <div class="podcast__item">
                        <div class="podcast__item__pic">
                            <img src="@/assets/img/podcast/podcast-4.jpg" alt="">
                        </div>
                        <div class="podcast__item__text">
                            <a href="#" class="heart-icon"><i class="fa fa-heart"></i></a>
                            <ul>
    ...
    <section class="callto spad set-bg" :style="{'background-image': 'url('+ require('@/assets/img/call-bg.jpg' ) + ')'}" data-setbg="img/call-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="episodes__item set-bg"    :style="{'background-image': 'url('+ require('@/assets/img/episodes/episodes-1.jpg' ) + ')'}">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="episodes__item set-bg"  :style="{'background-image': 'url('+ require('@/assets/img/episodes/episodes-2.jpg' ) + ')'}">
                        <div class="tags"><span class="icon_tags_alt"></span> Music, Radio</div>
                        <div class="time"><span class="icon_clock_alt"></span> 40 mins</div>
                        <a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/249690664&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true" class="play-btn video-popup"><img src="img/play.png" alt=""></a>
                        <div class="episodes__text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="episodes__item set-bg"  :style="{'background-image': 'url('+ require('@/assets/img/episodes/episodes-3.jpg' ) + ')'}">
                        <div class="tags"><span class="icon_tags_alt"></span> Music, Radio</div>
                        <div class="time"><span class="icon_clock_alt"></span> 40 mins</div>
                        <a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/249690664&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true" class="play-btn video-popup"><img src="img/play.png" alt=""></a>
                        <div class="episodes__text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="episodes__item set-bg"  :style="{'background-image': 'url('+ require('@/assets/img/episodes/episodes-4.jpg' ) + ')'}">
                        <div class="tags"><span class="icon_tags_alt"></span> Music, Radio</div>
                        <div class="time"><span class="icon_clock_alt"></span> 40 mins</div>
                        <a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/249690664&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true" class="play-btn video-popup"><img src="img/play.png" alt=""></a>
                        <div class="episodes__text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="episodes__item set-bg"  :style="{'background-image': 'url('+ require('@/assets/img/episodes/episodes-5.jpg' ) + ')'}">
                        <div class="tags"><span class="icon_tags_alt"></span> Music, Radio</div>
                        <div class="time"><span class="icon_clock_alt"></span> 40 mins</div>
                        <a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/249690664&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true" class="play-btn video-popup"><img src="img/play.png" alt=""></a>
                        <div class="episodes__text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="episodes__item set-bg"  :style="{'background-image': 'url('+ require('@/assets/img/episodes/episodes-6.jpg' ) + ')'}">
                        <div class="tags"><span class="icon_tags_alt"></span> Music, Radio</div>
                        <div class="time"><span class="icon_clock_alt"></span> 40 mins</div>
                        <a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/249690664&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true" class="play-btn video-popup"><img src="img/play.png" alt=""></a>
                        <div class="episodes__text">
    ...
    <footer class="footer set-bg"  :style="{'background-image':'url('+ require('@/assets/img/footer-bg.jpg' ) + ')'}" >
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-9 col-md-9">
                    <div class="footer__widget">
                        ...
                        <p class="footer__copyright__text">Copyright © {{new Date().getFullYear()}}
                            All rights reserved Niconet <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank"></a>
                        </p>
                    </div>
                </div>
